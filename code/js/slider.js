    ...
    $.fn.extend({
        tyslide:function(opts){
            ...
            $(this).each(function(index,item){//此处循环是因为选择器可能选择了页面上多个轮播
                ...
                var liRightMargin=parseInt($(item).find(".controls li").css("margin-right"));
                var w2=boxsount*(prams.controlsW+liRightMargin);//此宽度是controls的宽度
